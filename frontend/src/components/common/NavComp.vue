...
<template>
    <div class="subbx">
        ...
        <dl class="sub">
            <dt class="all">
                <a href="#" v-text="$store.state.setsubtit3" v-on:click.prevent="linksys($store.state.lnbsrc, 'shoes', '전체')"></a>
            </dt>
        ...
        <dl class="sub">
            <dt>
                <a href="#" v-text="$store.state.setsubtit4" v-on:click.prevent="linksys($store.state.lnbsrc, 'bag', '전체')"></a>
            </dt>
        ...
        <dl class="sub">
            <dt>
                <a href="#" v-text="$store.state.setsubtit5" v-on:click.prevent="linksys($store.state.lnbsrc, 'ac', '전체')"></a>
            </dt>
